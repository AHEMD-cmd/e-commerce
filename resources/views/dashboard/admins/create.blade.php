            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-colored-form-control">{{ __('dashboard.create_admin') }}
                        </h4>
                        ...
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('dashboard.admins.store') }}" method="POST">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="userinput1">
                                                    {{ __('dashboard.password_confirmation') }}</label>
                                                <input type="password" id="userinput1" class="form-control border-primary"
                                ...
                                <div class="form-actions right">
                                    <a href="{{ route('dashboard.admins.index') }}" type="button"
