                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:;">{{ __('dashboard.roles') }}</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    @forelse ($roles as $role)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @php
                                                    $permissions = collect(
                                                        Config::get('permissions_' . config('app.locale')),
                                                    )
                                                        ->filter(fn($value, $key) => in_array($key, $role->permissions))
                                                        ->values()
                                                        ->implode(', ');
                                                @endphp
