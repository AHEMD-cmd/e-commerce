                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-xl-12 col-lg-12">
                                        ...
                                        <div class="card faq_row" id="headingCollapse51">
                                            ...
                                            @forelse ($faqs as $item)
                                                <div id="faq_div_{{ $item->id }}">
                                                    <div role="tabpanel" class="card-header border-success">
                                                        ...
                                                        <a faq-id="{{ $item->id }}" class="delete_confirm_btn"
                                                            href=""><i class="la la-trash float-right"></i></a>
                                                        <a data-target="#faqEditModal_{{ $item->id }}"
                                            ...
                                            @empty
                                                <div id="faq_no_data" class="alert alert-info">
                                                    {{ __('dashboard.no_data') }}</div>
                                            @endforelse
                    ...
                    if (data.status == 'error') {
                        ...
                        $('.faq_row').prepend(`<div role="tabpanel" class="card-header border-success">
                                                    <a data-toggle="collapse" href="#collapse51_${data.faq.id}"
                                                        aria-expanded="true" aria-controls="collapse51_${data.faq.id}"
